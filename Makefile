...
llm:
	while true; do $(PYTHON) core/llm_llama.py -m "$(LLM_MODEL)"; sleep 1; done
...
build-ui:
	...
	cd $(WEBCHAT) && awatch -p static ../js/util.js ../js/debug.js -e static/service_worker.js -a -J ./Makefile
