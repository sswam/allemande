...
whisper:
	while true; do make mount && nice ionice $(PYTHON) core/stt_whisperx.py -v; sleep 1; done
...
watch:
	awatch -I -r -A -x bb yml safetensors txt -p $(ROOMS) $(AGENTS) -F meta >> $(WATCH_LOG)  # -L was there, to follow symlinks; why?
