...
sshfs -o allow_other -o kernel_cache,noforget,remember=86400,dcache_timeout=86400,dcache_stat_timeout=86400,dcache_link_timeout=86400,dcache_dir_timeout=86400,entry_timeout=86400,attr_timeout=86400,negative_timeout=86400,dcache_max_size=100000 10.0.1.50:rooms/ rooms.extra.raw
fusecache rooms.extra.raw rooms.extra.cache rooms.extra -o allow_other
