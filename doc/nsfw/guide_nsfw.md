...
These variants on the Gemini and DeepSeek models use a very short prompt to enable NSFW, which might be helpful if there is no other NSFW context. This is just a tiny prompt to give permission, not a jailbreak. The Elly, Ellyn, Misti, Veni and Venni models do not need such a prompt.
...
| DeepSeek   | DeepSeek V4 Flash     | Desee  | $0.22 | $0.66  | DeepSeek's fast, creative and intelligent chat model.                                                   |
| DeepSeek   | DeepSeek V4 Pro       | Deseri | $0.66 | $1.98  | DeepSeek's strongest model.                                                                             |
