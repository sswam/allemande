...
speak="speak.py --model coqui:tts_models/en/ek1/tacotron2 --tempo 1.0 --pitch 2"  # 4
#speak="speak.py --model gtts:en:co.uk --tempo 1.3 --pitch 3"
#speak="speak.py --model coqui:tts_models/en/ljspeech/tacotron2-DDC_ph --tempo 1.4 --pitch 7"
